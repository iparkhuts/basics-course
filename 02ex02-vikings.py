...
FORBIDDEN = {'not', 'without', 'no', 'coffee', 'tea', 'milk'}
...
D_CHOICE = '> '
D_PROMOTE = "Today's specials {dishes}" + f', and the top from the chef {PREFERED}...'
D_GOOD = "That's a perfect choice. Let's have more {dishes}" + f', and {PREFERED}!'
D_BAD = "Will not bring that. Who eats {dishes}?"
D_UNAVAILABLE = "That's out of our menu.\nWe have {dishes}."
